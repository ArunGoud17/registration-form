This project is a simple web application that allows users to register by filling out a registration form. The backend is built with Express.js and the data is stored in a MongoDB database.
